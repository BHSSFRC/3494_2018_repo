...
public class ReflectivePursuit extends Command {
    ...
    protected void execute() {
        if (Robot.limelight.hasValidTarget()) {
            Robot.driveTrain.ArcadeDrive(0.5, Robot.driveTrain.getPidTune(), true);
    ...
    protected boolean isFinished() {
        return (Robot.driveTrain.getSonicDistance() <= 24.0D) && (Robot.driveTrain.getCurrentTotal() > 30.0D);
    }
}
